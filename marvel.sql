...
-- 3. Oops! Someone spelled Krusty The Clown’s name wrong!
...
SELECT * FROM movies;
-- 6. We forgot one of the main characters!
-- Add Bart Simpson to the ‘people’ table
INSERT INTO people (name) VALUES ('Bart Simpson');
SELECT name FROM people;
-- 7. Eric Cartman has decided to hijack our movie evening,
...
('Avengers: Infinity War', 2019, '24:00');
SELECT * FROM movies;
...
DELETE FROM movies WHERE show_time > '22:00';
SELECT * FROM movies;
